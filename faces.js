...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'angry_f.xlsx', 'path': 'angry_f.xlsx'},
      {'name': '1_angry_f.xlsx', 'path': '1_angry_f.xlsx'},
      {'name': '2_angry_f.xlsx', 'path': '2_angry_f.xlsx'},
      {'name': '3_angry_f.xlsx', 'path': '3_angry_f.xlsx'},
    {'name': 'angry_m.xlsx', 'path': 'angry_m.xlsx'},
       {'name': '1_angry_m.xlsx', 'path': '1_angry_m.xlsx'},
      {'name': '2_angry_m.xlsx', 'path': '2_angry_m.xlsx'},
      {'name': '3_angry_m.xlsx', 'path': '3_angry_m.xlsx'},
    {'name': 'happy_f.xlsx', 'path': 'happy_f.xlsx'},
      {'name': '1_happy_f.xlsx', 'path': '1_happy_f.xlsx'},
      {'name': '2_happy_f.xlsx', 'path': '2_happy_f.xlsx'},
      {'name': '3_happy_f.xlsx', 'path': '3_happy_f.xlsx'},
    {'name': 'happy_m.xlsx', 'path': 'happy_m.xlsx'},
      {'name': '1_happy_m.xlsx', 'path': '1_happy_m.xlsx'},
      {'name': '2_happy_m.xlsx', 'path': '2_happy_m.xlsx'},
      {'name': '3_happy_m.xlsx', 'path': '3_happy_m.xlsx'},
